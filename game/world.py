from wecs.core import World as ECSWorld
...
class World(ECSWorld, DirectObject):
    def __init__(self):
        ECSWorld.__init__(self)
        ...
        self.dolmen = self.create_entity(
            TerrainObject(
                self.terrain,
        ...
        self.superflower = self.create_entity(
            TerrainObject(
                self.terrain,
        ...
        shrub_positions = [
            ...
            (138.0930743722364, 110.28490059860476, 0),
        ]
        self.shrubs = []
        for pos in shrub_positions:
            scale = random()*0.125+0.25
            dir = random()*360
            sub = choice([
                '**/tree',
                '**/tree.001',
        ...
        #render.find("**/butterfly").set_color((2.0, 0.5, 1.0, 1), 10000)
    ...
    def run_system(self, system, task):
